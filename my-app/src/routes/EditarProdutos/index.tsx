...
export default function EditarProdutos() {
  ...
  //dois sinais de igual é para comparar o valoe e um é para comparar o tipo de dado, por isso é necessário converter o id para number, pois ele vem como string:
