...
export const listaProdutos = [
  {
    ...
    preco: 299.90,
    descricao:
      "Áudio espacial 7.1, microfone com cancelamento de ruído e bateria de até 20 horas.",
    avatar:
  ...
  },
  {
    ...
    preco: 249.00,
    descricao:
      "Switches azuis táteis, layout compacto 60% e iluminação RGB customizável.",
    avatar:
  ...
  },
  {
    ...
    preco: 189.50,
    descricao:
      "Monitoramento de frequência cardíaca, contador de passos e resistência à água 5ATM.",
    avatar:
  ...
  },
  {
    ...
    preco: 420.00,
    descricao:
      "Impressão de fotos na hora com ajuste automático de exposição e lente macro integrada.",
    avatar:
  ...
  },
  {
    ...
    preco: 159.90,
    descricao:
      "Compartimento acolchoado até 15.6'', tecido impermeável e entrada USB externa.",
    avatar:
